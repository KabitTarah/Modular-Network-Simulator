...
/******************************************************************************\
 | This is not a direct part of the Modular Network Simulator. It is the basis |
 | for the Event Manager. This code was taken from:                            |
 | http://www.devsource.com/c/a/Languages/A-Priority-Queue-Implementation-in-C |
 | and http://www.mischel.com/pubs/priqueue.zip                                |
 | The code was written by Jim Mischel.                                        |
 | The licensing for this code is described as "You are free to use the code   |
 | in any manner you like." in the devsource.com article.                      |
\******************************************************************************/


namespace PriorityQueue
{
    // This is taken from http://www.devsource.com/c/a/Languages/A-Priority-Queue-Implementation-in-C
