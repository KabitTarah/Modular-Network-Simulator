...
namespace PEQ
{
    public class PEQRandomDetectionEventGenerator : IApplicationEventGenerator, 
        IReportSubject
    {
        ...
        public PEQRandomDetectionEventGenerator()
        {
            isInitialized = false;
        }

        public PEQRandomDetectionEventGenerator(IEventManager eventMgr, INodes nodes,
